...
The node currently has `r nrow(x)` data partners, you can find more information about each one of them in [Data Partners](data_partners/index.qmd). See them located in this map:
